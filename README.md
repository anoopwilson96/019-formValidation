This is a form validation using JavaScript. I created a signup page for an online chatting website '24 x 7 chat'. The signup page asks for a Name, a valid email ID, and a strong password.
